...
export const CommunityAds: React.FC = () => {
  ...
  return (
    <section id="ads-section" className="py-16 bg-gradient-to-b from-slate-900 via-slate-950 to-slate-900 text-white relative overflow-hidden border-t-4 border-amber-500 w-full max-w-full">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10 pb-6 border-b border-amber-500/20">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <button
              onClick={() => setIsMarketingAdModalOpen(true)}
              className="px-5 py-3 rounded-2xl bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-black text-xs sm:text-sm border border-emerald-300 shadow-xl flex items-center gap-2 transition-all transform hover:scale-105 cursor-pointer"
            >
              <Megaphone className="w-4 h-4 text-emerald-100 animate-pulse" />
